...
public abstract class HypsometricCurveChart_generated extends star.hydrology.ui.chart.AbstractChart implements star.event.EventController, star.event.Listener
{
	private star.event.Adapter adapter;
	private static final long serialVersionUID = 1L;

	public  HypsometricCurveChart_generated()
	{
		super();
	}
	...
	private void eventRaisedHandles(final star.event.Event event)
	{
		if( event.getClass().getName().equals( "star.hydrology.events.HypsometricCurveEvent" ) && event.isValid() ) 
		{
			...
			handleEvent( (star.hydrology.events.HypsometricCurveRaiser)event.getSource());
	...
	abstract void handleEvent(star.hydrology.events.HypsometricCurveRaiser r);
